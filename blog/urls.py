...
from . import views
from .views import BlogListView, BlogDetailView, BlogCreateView, BlogUpdateView, BlogDeleteView, BlogListTagView


urlpatterns = [
    path('', BlogListView.as_view(), name = 'blog-home'),
    path('category/<str:tag>/', views.blogs_tag, name = 'blog-tag'),
